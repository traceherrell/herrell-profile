const history = [
  {
    ...
    urls: ["https://www.redhat.com"],
    highlights: [
      "Responsibilities varied between fortune 50 customers. But typically, I functioned as Software Engineer or as an SRE providing best practices and guidance for developing software on Red hat OpenShift, ARO, and Ansible Automation Platform.",
      "Designed and developed a web application in React which provided a front end to an Ansible Automation Platform environment.  Features included network governance, change control, error logs, and re-runnability.",
    ],
  },
  {
    company: "T-Mobile",
    ...
    urls: [
      "https://www.t-mobile.com/plans",
      "https://www.t-mobile.com/cell-phones",
    ],
    highlights: [
      "Provided high level solution design, LOE’s, and technical guidance to product and delivery teams in the digital commerce space.",
  ...
  },
  {
    ...
    highlights: [
      "With a focus on micro service design patterns, running on Azure cloud services, I led a team of developers in building a new learning platform.",
  ...
  },
  {
    ...
    highlights: [
      "Led team in refactoring and developing new architecture for the Bluetooth qualification process. Migrated from legacy cold fusion technology to more service-oriented architecture utilizing: Restful Web Api (ASP.Net Web Api 2.0), Entity Framework, Ninject (IoC), SQL Server, and a modern component-based JavaScript application (VueJS).",
  ...
  },
  {
    ...
    highlights: [
      "Complete responsive redesign and architecture overall to John L. Scott's public facing web search tools as we well as the back-end broker tools.   Bringing the design and development of their systems back in house from a hosted third party.",
  ...
  },
  {
    ...
    urls: [
      "https://www.seattlechildrens.org/healthcare-professionals/access-services/partnership-access-line/meet-the-team/",
  ...
  },
  {
    ...
    highlights: [
      "Shipped 6 releases with major feature updates the largest of which was an improvement to the accounting system, allowing customers to split invoices across multiple cost centers.  As well as developing the feature, I implemented a new integration testing framework that would load complete customers and agency accounting data during the integration build, decreasing the amount of functional testing needed and ultimately decreasing our time to market (TTM).",
